intellisense.annotate(jQuery, {
  ...
  'grep': function() {
    ...
    ///   <param name="array" type="Array">The array to filter through.</param>
  ...
  'inArray': function() {
    /// <signature>
    ///   <summary>filter for a specified value within an array and return its index (or -1 if not found).</summary>
    ///   <param name="value" type="Anything">The value to filter for.</param>
    ///   <param name="array" type="Array">An array through which to filter.</param>
    ///   <param name="fromIndex" type="Number">The index of the array at which to begin the filter. The default is 0, which will filter the whole array.</param>
    ///   <returns type="Number" />
    /// </signature>
  },
  'isArray': function() {
...
intellisense.annotate(_object, {
  ...
  'has': function() {
    ...
    ///   <param name="callback" type="Function">The callback to filter for.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'lock': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'class': function() {
    ...
    ///   <param name="class" type="String">A class to filter for. An element can have multiple classes; only one of them must match.</param>
    /// </signature>
  },
  'clearQueue': function() {
    /// <signature>
  ...
  'element': function() {
    ...
    ///   <param name="element" type="String">An element to filter for. Refers to the tagName of DOM nodes.</param>
    /// </signature>
  },
  'empty': function() {
  ...
  'hasClass': function() {
    ...
    ///   <param name="className" type="String">The class name to filter for.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'header': function() {
  ...
  'id': function() {
    ...
    ///   <param name="id" type="String">An ID to filter for, specified via the id attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
  ...
  'index': function() {
    /// <signature>
    ///   <summary>filter for a given element from among the matched elements.</summary>
