...
ko.expressionRewriting = (function () {
    ...
    return {
        ...
        //                      This will be filtered for a '_ko_property_writers' property in case you're writing to a non-observable
...
(function () {
    ...
    function topologicalSortBindings(bindings) {
        ...
        var result = [],                // The list of key/handler pairs that we will return
            ...
            cyclicDependencyStack = []; // Keeps track of a depth-filter so that, if there's a cycle, we know which bindings caused it
